...
filerange=[58,17];%79;%58,[35,37,39]
...
for j=1:nrel
    ...
    [tform12{j},m12{j}] = pcregistericp(ptcld2,ptcld1,'Extrapolate',true,'Metric','pointToPlane','Tolerance',[0.001, 0.005],'MaxIterations',100);
    [tform13{j},m13{j}] = pcregistericp(ptcld3,ptcld1,'Extrapolate',true,'Metric','pointToPlane','Tolerance',[0.001, 0.005],'MaxIterations',100);
...
R_12_icp=tform12{2}.T(1:3,1:3)';R_13_icp=tform13{1}.T(1:3,1:3)';
t_12_icp=tform12{2}.T(4,1:3)';t_13_icp=tform13{1}.T(4,1:3)';
