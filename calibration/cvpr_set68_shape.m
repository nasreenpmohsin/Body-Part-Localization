...
l=legend(a,'chessboard','planar','ICP','proposed with IR data','proposed with depth data');
...
l=legend([p1,p2],'chessboard','[21]','ICP','proposed with IR data','proposed with depth data','Actual cylindrical radius: 0.095m');
xlabel('Cylinder pose');
ylabel('Radius of estimated cylinder [m]');
